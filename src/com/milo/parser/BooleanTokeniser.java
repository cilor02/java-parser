...
public class BooleanTokeniser {
	...
	public BooleanTokeniser(String phrase)
	{
		this.phrase = phrase;
	}
...
//				break;
	...
	private void possibleAnd()
	{
		this.currentToken.append(latestChar);
		 latestChar = getNext();
		 if(latestChar == 'n')
		 {
			 currentToken.append(latestChar);
			 latestChar = getNext();
			 if(latestChar == 'd')
			 {
				 currentToken.append(latestChar);
	...
	{
		BooleanTokeniser tokeniser = new BooleanTokeniser("436.7 + 6*5**2 + 10.5 / 7.556-a+cd/x");
